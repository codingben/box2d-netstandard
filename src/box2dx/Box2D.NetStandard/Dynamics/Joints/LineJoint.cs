...
namespace Box2DX.Dynamics
{
	...
	public class LineJoint : Joint
	{
			...
			: base(def)
		{
			...
			_localYAxis1 = Vectex.Cross(1.0f, _localXAxis1);
		...
		public float GetJointSpeed()
		{
			...
			Vector2 r1 = Box2DX.Common.Math.Mul(b1.GetXForm().R, _localAnchor1 - b1.GetLocalCenter());
			Vector2 r2 = Box2DX.Common.Math.Mul(b2.GetXForm().R, _localAnchor2 - b2.GetLocalCenter());
			...
			float speed = Vector2.Dot(d, Vectex.Cross(w1, axis)) + Vector2.Dot(axis, v2 + Vectex.Cross(w2, r2) - v1 - Vectex.Cross(w1, r1));
			return speed;
		}
