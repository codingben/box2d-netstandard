...
namespace Box2D.NetStandard.Collision {
  internal class PolygonAndPolygonCollider : Collider<PolygonShape, PolygonShape> {
    internal override void Collide(out Manifold manifold, in PolygonShape polyA, in Transform xfA, in PolygonShape polyB, in Transform xfB) {
    ...
    private static float FindMaxSeparation(out int edgeIndex, in PolygonShape poly1, in Transform xf1, in PolygonShape poly2, in Transform xf2)
    {
      int       count1 = poly1.m_count;
